...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "- Target IP is by default set to your ip address."
        '
        'Label2
        '
        ...
        Me.Label2.Text = "- To get a website ip address hit the windows key and"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "run cmd. Type ping website to get the ip address"
        '
        'Label4
        '
        ...
        Me.Label4.Text = "IE. ping www.miniclip.com"
        '
        'Form1
        '
